    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(forum.this , Search.class);
        ...
        Newestt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(forum.this , Newestt.class);
                startActivity(intent);
            }
        });
        ...
        Newestt2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(forum.this , Newestt2.class);
                startActivity(intent);
            }
        });
        ...
        Knowhow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(forum.this , Knowhow.class);
                startActivity(intent);
            }
        });
        ...
        history.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(forum.this , history.class);
                startActivity(intent);
            }
        });
        ...
        forum.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(forum.this , forum.class);
                startActivity(intent);
            }
        });
        ...
        suggestion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(forum.this , suggestion.class);
                startActivity(intent);
            }
        });

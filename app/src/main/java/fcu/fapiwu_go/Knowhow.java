...
public class Knowhow extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(Knowhow.this , Search.class);
        ...
        Newestt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Knowhow.this , Newestt.class);
                startActivity(intent);
            }
        });
        ...
        Newestt2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Knowhow.this , Newestt2.class);
                startActivity(intent);
            }
        });
        ...
        Knowhow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Knowhow.this , Knowhow.class);
                startActivity(intent);
            }
        });
        ...
        history.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Knowhow.this , history.class);
                startActivity(intent);
            }
        });
        ...
        forum.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Knowhow.this , forum.class);
                startActivity(intent);
            }
        });
        ...
        suggestion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Knowhow.this , suggestion.class);
                startActivity(intent);
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.knowhow, menu);
        return true;
    }

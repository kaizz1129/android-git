    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(history.this , Search.class);
        ...
        Newestt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(history.this , Newestt.class);
                startActivity(intent);
            }
        });
        ...
        Newestt2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(history.this , Newestt2.class);
                startActivity(intent);
            }
        });
        ...
        Knowhow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(history.this , Knowhow.class);
                startActivity(intent);
            }
        });
        ...
        forum.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(history.this , forum.class);
                startActivity(intent);
            }
        });
        ...
        suggestion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(history.this , suggestion.class);
                startActivity(intent);
            }
        });
        ...
        welcome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(history.this , Welcome.class);
                startActivity(intent);
            }
        });

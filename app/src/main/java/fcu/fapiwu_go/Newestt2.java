...
public class Newestt2 extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_newestt2);
        ...
        Search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(Newestt2.this , Search.class);
        ...
        Newestt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Newestt2.this , Newestt.class);
                startActivity(intent);
            }
        });
        ...
        Newestt2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Newestt2.this , Newestt2.class);
                startActivity(intent);
            }
        });
        ...
        Knowhow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Newestt2.this , Knowhow.class);
                startActivity(intent);
            }
        });
        ...
        history.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Newestt2.this , history.class);
                startActivity(intent);
            }
        });
        ...
        forum.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Newestt2.this , forum.class);
                startActivity(intent);
            }
        });
        ...
        suggestion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Newestt2.this , suggestion.class);
                startActivity(intent);
            }
        });
        ...
        welcome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Newestt2.this , Welcome.class);
                startActivity(intent);
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.newestt2, menu);
        return true;
    }

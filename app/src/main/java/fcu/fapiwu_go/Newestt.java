...
public class Newestt extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_newestt);
        ...
        Search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(Newestt.this , Search.class);
        ...
        Newestt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Newestt.this , Newestt.class);
                startActivity(intent);
            }
        });
        ...
        Newestt2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Newestt.this , Newestt2.class);
                startActivity(intent);
            }
        });
        ...
        Knowhow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Newestt.this , Knowhow.class);
                startActivity(intent);
            }
        });
        ...
        history.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Newestt.this , history.class);
                startActivity(intent);
            }
        });
        ...
        forum.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Newestt.this , forum.class);
                startActivity(intent);
            }
        });
        ...
        suggestion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Newestt.this , suggestion.class);
                startActivity(intent);
            }
        });
        ...
        welcome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Newestt.this , Welcome.class);
                startActivity(intent);
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.newestt, menu);
        return true;
    }
